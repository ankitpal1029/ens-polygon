...
contract Domains is ERC721URIStorage{
    ...
    constructor(string memory _tld) payable ERC721("Yangit Name Service","YNS") {
        tld = _tld;
    ...
    function setRecord(string calldata name, string calldata message, string calldata email) public {
    ...
    function getRecord(string calldata name) public view returns(Records memory){
        return records[name];
    }
